...
def datacite_etree(pid, record):
    ...
    if f.find('identifier') is None:
        ...
        identifier.text=f"https://{request.host}/record/{record['_source'].get('recid')}"
    return f
...
class DataCiteSerializer(Schema):
    ...
    def get_description(self, obj):
        ...
        if "abstract" in obj and "description" in obj["abstract"]:
            descriptions.append( {"descriptionType":"abstract", "description": obj["abstract"]["description"]})
        return descriptions
    ...
    def get_resourcetype(self, obj):
        ...
        return {"resourceTypeGeneral": resource_type, "resourceType": resource_type, }

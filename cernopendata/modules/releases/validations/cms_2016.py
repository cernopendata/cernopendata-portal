...
class CMS_2016_Simulated(ExpectedFieldsValidation):
    ...
    expected_fields = {
        ...
        "methodology.description": '<p>These data were generated in several steps (see also <a href="/docs/cms-mc-production-overview">CMS Monte Carlo production overview</a>):</p>',
        "pileup": {
            "description": '<p>To make these simulated data comparable with the collision data, <a href="/docs/cms-guide-pileup-simulation">pile-up events</a> are added to the simulated event in the DIGI2RAW step.</p>',
            "links": [
                {
                    "recid": "30595",

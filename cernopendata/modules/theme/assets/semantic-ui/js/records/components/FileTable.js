              ...
              {hasOnDemandColumn && (
                <Table.Cell>
                  {file.availability?.ondemand && (
                    <div className="ui mini message" data-content={file.availability.online ? "Some files of the dataset are available for immediate download" : "The files have to be requested before they are available"}>
                      {file.availability.online ? "Partially" : "On demand"}
                    </div>
                  )}
                </Table.Cell>
              )}
